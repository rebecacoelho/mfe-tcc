...
/**
 * Componente exposto via Module Federation como 'cartMfe/CartPage'.
 * Recebe o estado do carrinho por props vindas do shell (dono do estado).
 * Assim o MFE de carrinho permanece desacoplado e reutilizável.
 */
